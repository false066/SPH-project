          ...
          <div class="goodsDetail">
            ...
            <div class="priceArea">
              <div class="priceArea1">
                ...
                <div class="price">
                  <i>¥</i>
                  <em>{{ skuInfo.price != undefined || null ? skuInfo.price.toFixed(2) : 0 }}</em>
                  <!-- 使用空值合并运算符 (??) 来提供一个默认值（即 0），以确保在 skuInfo.price 为 null 或 undefined 时，parseInt() 函数也能够正常工作。 -->
                  <!-- <em>{{ parseInt(skuInfo.price ?? '0').toFixed(2) }}</em> -->
                  <span>降价通知</span>
                </div>
                <div class="remark">
                  <i>累计评价</i>
          ...
          <div class="choose">
            ...
            <div class="cartWrap">
              ...
              <div class="add">
                ...
                发请求把你购买的产品的信息通过请求的形式通知服务气，服务器进行存储 -->
